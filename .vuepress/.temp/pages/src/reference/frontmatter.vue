...
<p>Also see:</p>
<ul>
<li><RouterLink to="/src/reference/config.html#lang">Config &gt; lang</RouterLink></li>
</ul>
</li>
</ul>
...
<p>Also see:</p>
<ul>
<li><RouterLink to="/src/reference/config.html#description">Config &gt; description</RouterLink></li>
</ul>
</li>
</ul>
...
<li>Also see:
<ul>
<li><RouterLink to="/src/reference/config.html#head">Config &gt; head</RouterLink></li>
</ul>
</li>
</ul>
...
<li><RouterLink to="/src/guide/page.html#routing">Guide &gt; Page &gt; Routing</RouterLink></li>
</ul>
</li>
</ul>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>Then the permalink of the page would be <code>2021/01/03/foo-bar.html</code>.</p>
<ul>
<li>
<p>Example 2:</p>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>Then the permalink of the page would be <code>2021/01/03/bar-baz.html</code>.</p>
<ul>
<li>Also see:
<ul>
...
<p>Layouts are provided by theme. If you don't specify this frontmatter, the default layout will be used. A theme may provide other layouts, and you should refer to the theme documentation for detailed guide.</p>
</li>
</ul>
</template>