...
<p>Learn more: <RouterLink to="/src/guide/advanced/markdown.html">Advanced &gt; Markdown and Vue SFC</RouterLink></p>
<p>Alternatively, you can use the <RouterLink to="/src/reference/default-theme/markdown.html#custom-containers">custom containers</RouterLink>.</p>
</div>
</template>