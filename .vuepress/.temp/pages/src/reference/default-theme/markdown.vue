...
<li>Alias of <RouterLink to="/src/reference/default-theme/components.html#codegroup">CodeGroup</RouterLink> and <RouterLink to="/src/reference/default-theme/components.html#codegroupitem">CodeGroupItem</RouterLink>:
<ul>
