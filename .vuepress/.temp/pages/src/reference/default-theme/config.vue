...
<p>Reference of default theme config, which can be set via <RouterLink to="/src/reference/config.html#themeconfig">themeConfig</RouterLink>.</p>
...
<p>This options will only take effect in default theme, so don't confuse with <code>locales</code> in <RouterLink to="/src/reference/config.html#locales">Site Config</RouterLink>.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<li>Also see:
<ul>
<li><RouterLink to="/src/guide/assets.html#public-files">Guide &gt; Assets &gt; Public Files</RouterLink></li>
</ul>
</li>
</ul>
...
<p>The <em>select language menu</em> will appear next to the repository button in the navbar when you set multiple <RouterLink to="/src/reference/config.html#locales">locales</RouterLink> in your site config.</p>
</li>
</ul>
...
<p>You can override this global option via <RouterLink to="/src/reference/default-theme/frontmatter.html#sidebar">sidebar</RouterLink> frontmatter in your pages.</p>
...
<p>You can override this global option via <RouterLink to="/src/reference/default-theme/frontmatter.html#editlink">editLink</RouterLink> frontmatter in your pages.</p>
</li>
</ul>
...
<p>You can override this global option via <RouterLink to="/src/reference/default-theme/frontmatter.html#lastupdated">lastUpdated</RouterLink> frontmatter in your pages.</p>
...
<p>You can override this global option via <RouterLink to="/src/reference/default-theme/frontmatter.html#contributors">contributors</RouterLink> frontmatter in your pages.</p>
...
<li>
<p>Details:</p>
<p>Specify the default title of the tip <RouterLink to="/src/reference/default-theme/markdown.html#custom-containers">custom containers</RouterLink>.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Specify the default title of the warning <RouterLink to="/src/reference/default-theme/markdown.html#custom-containers">custom containers</RouterLink>.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Specify the default title of the danger <RouterLink to="/src/reference/default-theme/markdown.html#custom-containers">custom containers</RouterLink>.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Specify the <code>sr-only</code> text of the <RouterLink to="/src/reference/components.html#outboundlink">OutboundLink</RouterLink>.</p>
<p>This is mainly for a11y purpose.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/src/reference/plugin/active-header-links.html">@vuepress/plugin-active-header-links</RouterLink> or not.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/src/reference/plugin/back-to-top.html">@vuepress/plugin-back-to-top</RouterLink> or not.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable custom containers that powered by <RouterLink to="/src/reference/plugin/container.html">@vuepress/plugin-container</RouterLink> or not.</p>
...
<p>Also see:</p>
<ul>
<li><RouterLink to="/src/reference/default-theme/markdown.html#custom-containers">Default Theme &gt; Markdown &gt; Custom Containers</RouterLink></li>
</ul>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/src/reference/plugin/git.html">@vuepress/plugin-git</RouterLink> or not.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/src/reference/plugin/medium-zoom.html">@vuepress/plugin-medium-zoom</RouterLink> or not.</p>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/src/reference/plugin/nprogress.html">@vuepress/plugin-nprogress</RouterLink> or not.</p>
</li>
</ul>
</template>