...
<p>Config reference: <RouterLink to="/src/reference/config.html#public">public</RouterLink></p>
</div>
<h3 id="base-helper"><a class="header-anchor" href="#base-helper">#</a> Base Helper</h3>
<p>If your site is deployed to a non-root URL, i.e. the <RouterLink to="/src/reference/config.html#base">base</RouterLink> is not <code>&quot;/&quot;</code>, you will need to prepend the <code>base</code> to the absolute URLs of your public files.</p>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>Config reference: <RouterLink to="/src/reference/config.html#base">base</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#alias">alias</RouterLink></p>
</div>
</template>