...
<p>Check out the <RouterLink to="/src/reference/frontmatter.html">Frontmatter Reference</RouterLink> for a full list of VuePress built-in frontmatter.</p>
<p>Check out the <RouterLink to="/src/reference/default-theme/frontmatter.html">Default Theme &gt; Frontmatter Reference</RouterLink> for the frontmatter of default theme.</p>
</div>
...
<p>With the power of <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noopener noreferrer">markdown-it<OutboundLink/></a> and Vue template syntax, the basic Markdown can be extended a lot. Next, check out the <RouterLink to="/src/guide/markdown.html">Markdown</RouterLink> guide for all the extensions of Markdown in VuePress.</p>
</template>