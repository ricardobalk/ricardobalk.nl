...
<p>With the help of <RouterLink to="/src/reference/plugin-api.html">Plugin API</RouterLink>, VuePress plugin can provide different features for you.</p>
...
<p>In general, you need to specify the name of the plugin to use in <RouterLink to="/src/reference/plugin-api.html#plugins">plugins</RouterLink> option:</p>
...
<p>It is recommended to use the <RouterLink to="/src/guide/configuration.html#config-file">Config File</RouterLink> directly as a plugin, because <RouterLink to="/src/reference/config.html#plugin-api">almost all of the Plugin APIs are available</RouterLink>, which would be more convenient in most cases.</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>You can refer to <RouterLink to="/src/guide/advanced/plugin.html">Advanced &gt; Writing a Plugin</RouterLink> for how to write your own plugin.</p>
</template>