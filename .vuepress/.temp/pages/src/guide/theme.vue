...
<p>In general, you need to specify the name of the theme to use in <RouterLink to="/src/reference/config.html#theme">theme</RouterLink> option:</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>Next, refer to <RouterLink to="/src/guide/advanced/theme.html">Advanced &gt; Writing a Theme</RouterLink> for how to write your own theme.</p>
</template>