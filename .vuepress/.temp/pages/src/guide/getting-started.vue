...
<p>By now, you should have a basic but functional VuePress documentation site. Next, learn about the basics of <RouterLink to="/src/guide/configuration.html">configuration</RouterLink> in VuePress.</p>
</template>