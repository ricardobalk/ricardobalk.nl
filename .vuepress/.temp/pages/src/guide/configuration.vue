...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>Check out the <RouterLink to="/src/reference/config.html">Config Reference</RouterLink> for a full list of site config.</p>
</div>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>Check out the <RouterLink to="/src/reference/default-theme/config.html">Default Theme &gt; Config Reference</RouterLink> for theme config of default theme.</p>
</div>
</template>