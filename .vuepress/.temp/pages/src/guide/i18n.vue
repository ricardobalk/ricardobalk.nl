...
<p>Config reference: <RouterLink to="/src/reference/config.html#locales">locales</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/default-theme/config.html#locales">Default Theme &gt; locales</RouterLink></p>
</div>
</template>