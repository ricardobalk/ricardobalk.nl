...
<p>You can also configure those built-in extensions, load more markdown-it plugins and implement your own extensions via <RouterLink to="/src/reference/config.html#markdown">markdown</RouterLink> option and <RouterLink to="/src/reference/plugin-api.html#extendsmarkdown">extendsMarkdown</RouterLink> option.</p>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-anchor">markdown.anchor</RouterLink></p>
</div>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p><strong>Rendered as</strong></p>
<p><RouterLink to="/src/">Home</RouterLink><br>
<RouterLink to="/src/reference/config.html">Config Reference</RouterLink><br>
<RouterLink to="/src/guide/getting-started.html">Getting Started</RouterLink><br>
...
<li>Internal links to <code>.md</code> files will be converted to the <RouterLink to="/src/guide/page.html#routing">page route path</RouterLink>, and both absolute path and relative path are supported.</li>
...
<li>When using absolute paths, if the <RouterLink to="/src/reference/config.html#base">base</RouterLink> of your site is not <code>&quot;/&quot;</code>, you will need to prepend the <code>base</code> manually or use <RouterLink to="/src/guide/assets.html#base-helper">base helper</RouterLink>.</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>This links extension is supported by our built-in plugin.</p>
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-links">markdown.links</RouterLink></p>
<p>Also see: <RouterLink to="/src/reference/components.html#outboundlink">Built-in Components &gt; OutboundLink</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-emoji">markdown.emoji</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-toc">markdown.toc</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-code-highlight">markdown.code.highlight</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-code-highlightlines">markdown.code.highlightLines</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-code-linenumbers">markdown.code.lineNumbers</RouterLink></p>
</div>
...
<p>Config reference: <RouterLink to="/src/reference/config.html#markdown-vpre">markdown.code.vPre</RouterLink></p>
</div>
...
<p>Check out <RouterLink to="/src/guide/advanced/markdown.html">Advanced &gt; Markdown and Vue SFC</RouterLink> for more details.</p>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>Check out the <RouterLink to="/src/reference/components.html">Built-in Components</RouterLink> for a full list of built-in components.</p>
<p>Check out the <RouterLink to="/src/reference/default-theme/components.html">Default Theme &gt; Built-in Components</RouterLink> for a full list of default theme built-in components.</p>
</div>
</template>