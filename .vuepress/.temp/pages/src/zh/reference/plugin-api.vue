...
<li>参考：
<ul>
<li><RouterLink to="/src/zh/guide/plugin.html">指南 &gt; 插件</RouterLink></li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>类型： <code>(filePath: string, app: App) =&gt; PageOptions | Promise&lt;PageOptions&gt;</code></p>
</li>
<li>
<p>详情：</p>
<p>页面配置项扩展。</p>
<p>该 Hook 接收一个函数，在参数中会收到页面文件的相对路径。返回的对象会被合并到页面配置项中，用以创建页面。</p>
</li>
<li>
<p>示例：</p>
</li>
