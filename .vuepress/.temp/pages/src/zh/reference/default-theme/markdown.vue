...
<li><RouterLink to="/src/zh/reference/default-theme/components.html#codegroup">CodeGroup</RouterLink> 和 <RouterLink to="/src/zh/reference/default-theme/components.html#codegroupitem">CodeGroupItem</RouterLink> 的别名：
<ul>
