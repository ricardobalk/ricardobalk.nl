...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#public">public</RouterLink></p>
</div>
<h3 id="base-helper"><a class="header-anchor" href="#base-helper">#</a> Base Helper</h3>
<p>如果你的网站部署在非根路径下，即 <RouterLink to="/src/zh/reference/config.html#base">base</RouterLink> 不是 <code>&quot;/&quot;</code> ，你需要把 <code>base</code> 添加到 Public 文件的绝对路径前。</p>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#base">base</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#alias">alias</RouterLink></p>
</div>
</template>