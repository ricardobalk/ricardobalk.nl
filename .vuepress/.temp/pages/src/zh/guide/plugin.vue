...
<p>借助于 <RouterLink to="/src/zh/reference/plugin-api.html">Plugin API</RouterLink> ， VuePress 插件可以为你提供各种不同的功能。</p>
...
<p>一般而言，你需要在 <RouterLink to="/src/zh/reference/plugin-api.html#plugins">plugins</RouterLink> 配置项中设置你要使用的插件名称：</p>
...
<p>推荐你直接将 <RouterLink to="/src/zh/guide/configuration.html#%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">配置文件</RouterLink> 作为插件使用，因为 <RouterLink to="/src/zh/reference/config.html#%E6%8F%92%E4%BB%B6-api">几乎所有的插件 API 都可以在配置文件中使用</RouterLink>，这在绝大多数场景下都更为方便。</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>前往 <RouterLink to="/src/zh/guide/advanced/plugin.html">深入 &gt; 开发插件</RouterLink> 学习如何开发你自己的插件。</p>
</template>