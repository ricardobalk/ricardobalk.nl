...
└─ zh
   ...
   └─ nested
      └─ README.md
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>然后，在你的 <RouterLink to="/src/zh/guide/configuration.html#%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">配置文件</RouterLink> 中设置 <code>locales</code> 选项：</p>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#locales">locales</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/default-theme/config.html#locales">默认主题 &gt; locales</RouterLink></p>
</div>
</template>