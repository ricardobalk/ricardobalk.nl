...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>└─ docs
   ...
   ├─ contributing.md
   └─ README.md
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>将 <code>docs</code> 目录作为你的 <RouterLink to="/src/zh/reference/cli.html">sourceDir</RouterLink> ，例如你在运行 <code>vuepress dev docs</code> 命令。此时，你的 Markdown 文件对应的路由路径为：</p>
<table>
<thead>
<tr>
<th>相对路径</th>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>你肯定注意到 Frontmatter 中的字段和<RouterLink to="/src/zh/guide/configuration.html#config-file">配置文件</RouterLink>中的<RouterLink to="/src/zh/guide/configuration.html#%E7%AB%99%E7%82%B9%E9%85%8D%E7%BD%AE">站点配置</RouterLink>十分类似。你可以通过 Frontmatter 来覆盖当前页面的 <code>lang</code>, <code>title</code>, <code>description</code> 等属性。因此，你可以把 Frontmatter 当作页面级作用域的配置。</p>
<p>同样的，VuePress 有一些内置支持的 Frontmatter 字段，而你使用的主题也可能有它自己的特殊 Frontmatter 。</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>前往 <RouterLink to="/src/zh/reference/config.html">Frontmatter 参考</RouterLink> 查看 VuePress 支持的 Frontmatter 配置。</p>
<p>前往 <RouterLink to="/src/zh/reference/default-theme/frontmatter.html">默认主题 &gt; Frontmatter 参考</RouterLink> 查看默认主题的 Frontmatter 配置。</p>
</div>
...
<p>借助 <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noopener noreferrer">markdown-it<OutboundLink/></a> 和 Vue 模板语法的能力，基础的 Markdown 可以得到很多的扩展功能。接下来，前往 <RouterLink to="/src/zh/guide/markdown.html">Markdown</RouterLink> 章节来了解 VuePress 中 Markdown 的扩展功能。</p>
</template>