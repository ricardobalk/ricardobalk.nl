...
<p>VuePress 有一个开箱即用的默认主题，正使用在你当前正在浏览的文档网站上。默认主题为文档网站提供了基础且实用的功能，你可以前往 <RouterLink to="/src/zh/reference/default-theme/config.html">默认主题配置参考</RouterLink> 获取全部的配置列表。</p>
...
<p>一般而言，你需要在 <RouterLink to="/src/zh/reference/config.html#theme">theme</RouterLink> 配置项中设置你要使用的主题名称：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>接下来，前往 <RouterLink to="/src/zh/guide/advanced/theme.html">深入 &gt; 开发主题</RouterLink> 学习如何开发你自己的主题。</p>
</template>