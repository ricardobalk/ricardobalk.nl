...
<p>你也可以通过 <RouterLink to="/src/zh/reference/config.html#markdown">markdown</RouterLink> 和 <RouterLink to="/src/zh/reference/plugin-api.html#extendsmarkdown">extendsMarkdown</RouterLink> 来配置这些内置扩展、加载更多 markdown-it 插件、实现你自己的扩展等。</p>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-anchor">markdown.anchor</RouterLink></p>
</div>
...
<span class="token url">[<span class="token content">配置參考</span>](<span class="token url">../reference/config.md</span>)</span>  
...
<span class="token url">[<span class="token content">配置參考 > markdown.links</span>](<span class="token url">/zh/reference/config.md#links</span>)</span>  
<span class="token comment">&lt;!-- URL --></span>
<span class="token url">[<span class="token content">GitHub</span>](<span class="token url">https://github.com</span>)</span> 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p><strong>转换为</strong></p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>RouterLink</span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/zh/reference/config.html<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>配置參考<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>RouterLink</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>RouterLink</span> <span class="token attr-name">to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/zh/reference/config.html#links<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>配置參考 <span class="token entity named-entity" title="&gt;">&amp;gt;</span> markdown.links<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>RouterLink</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p><strong>渲染为</strong></p>
<p><RouterLink to="/src/zh/">首页</RouterLink><br>
<RouterLink to="/src/zh/reference/config.html">配置參考</RouterLink><br>
<RouterLink to="/src/zh/guide/getting-started.html">快速上手</RouterLink><br>
<RouterLink to="/zh/guide/">指南</RouterLink><br>
<RouterLink to="/zh/reference/config.html#links">配置參考 &gt; markdown.links</RouterLink><br>
...
<li>指向 <code>.md</code> 文件的内部链接会被转换为目标页面的 <RouterLink to="/src/zh/guide/page.html#%E8%B7%AF%E7%94%B1">路由路径</RouterLink>，并且支持绝对路径和相对路径。</li>
...
<li>在使用绝对路径时，如果你站点的 <RouterLink to="/src/zh/reference/config.html#base">base</RouterLink> 不是 <code>&quot;/&quot;</code>，你需要手动添加 <code>base</code> 或者使用 <RouterLink to="/src/zh/guide/assets.html#base-helper">base helper</RouterLink> 。</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>链接扩展是由我们的内置插件支持的。</p>
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-links">markdown.links</RouterLink></p>
<p>参考: <RouterLink to="/src/zh/reference/components.html#outboundlink">內置组件 &gt; OutboundLink</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-emoji">markdown.emoji</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-toc">markdown.toc</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-code-highlight">markdown.code.highlight</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-code-highlightlines">markdown.code.highlightLines</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-code-linenumbers">markdown.code.lineNumbers</RouterLink></p>
</div>
...
<p>配置参考： <RouterLink to="/src/zh/reference/config.html#markdown-vpre">markdown.code.vPre</RouterLink></p>
</div>
...
<p>可以前往 <RouterLink to="/src/zh/guide/advanced/markdown.html">深入 &gt; Markdown 和 Vue SFC</RouterLink> 来了解更多内容。</p>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>前往 <RouterLink to="/src/zh/reference/components.html">内置组件</RouterLink> 查看所有内置组件。</p>
<p>前往 <RouterLink to="/src/zh/reference/default-theme/components.html">默认主题 &gt; 内置组件</RouterLink> 查看默认主题中的所有内置组件。</p>
</div>
</template>