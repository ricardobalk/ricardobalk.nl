...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>前往 <RouterLink to="/src/zh/reference/config.html">配置参考</RouterLink> 查看所有站点配置。</p>
</div>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>前往 <RouterLink to="/src/zh/reference/default-theme/config.html">默认主题 &gt; 配置参考</RouterLink> 查看默认主题的配置。</p>
</div>
</template>