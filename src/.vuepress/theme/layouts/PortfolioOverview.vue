<template>
  <section class="portfolio-overview">
    <BigHero
      title="Portfolio"
      image="/assets/img/site/workbench.jpg"
      class="blog-hero"
    />
      ...
      <div class="masonry-container">
        <div class="masonry-columns items">
          <article
            ...
            v-if="
              item.frontmatter.portfolio === true &&
                (item.frontmatter.lang || 'en-GB') === $lang
            "
          ...
          >
            <a :href="item.path" class="clickable">
              <img
                ...
                :src="
                  `${assets.images}/${item.frontmatter.images.featured.filename}`
                "
                alt=""
              />
